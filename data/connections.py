...
connection2 = sqlite3.connect("data/users_tasks.db")
cursor2 = connection2.cursor()
cursor2.execute("CREATE TABLE IF NOT EXISTS users_tasks(user_name TEXT NOT NULL, title TEXT NOT NULL, content TEXT NOT NULL)")
connection2.commit()
connection2.close()